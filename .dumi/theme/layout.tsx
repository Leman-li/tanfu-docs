...
/**
 * 
 * @param hero     background-color: #1890ff!important;
...
const Hero = hero => (
  <>
    <div style={hero.bgImage ? {
      backgroundColor: '#8ed8b6',
      backgroundImage: `url(${hero.bgImage})`,
      backgroundRepeat: 'no-repeat',
      backgroundSize: 'contain',
      transition: 'all .3s'
    } : null} className="__dumi-default-layout-hero">
      {hero.image && <img src={hero.image} />}
      <h1>{hero.title}</h1>
      <div style={{ fontSize: 20, fontWeight: 'bold' }} dangerouslySetInnerHTML={{ __html: hero.desc }} />
      {hero.actions &&
